          ...
          <div className="border-b border-white/10">
            <div className="max-w-7xl mx-auto px-6 py-12">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                {/* Quick Links */}
                <div className="space-y-6">
                  <h4 className="text-lg font-bold mb-4" style={{ color: 'var(--cream-white)' }}>Company & Legal</h4>
                  <div className="space-y-3">
                    <Link
                      to="/about"
                      className="block text-lg hover:text-orange-400 transition-colors duration-300 text-left font-semibold text-orange-300"
                    >
                      Meet the Founder
                    </Link>
                    <button
